...
void loop() {
  int reading = digitalRead(dropperPin);
  ...
  if ((millis() - lastDebounce) > debounceDelay) {
    if (reading != drop) {
      ...
      if (drop == HIGH) {
        ...
        String flagString = String(flags);
        String latString = String(Latitude, 4);
        String lngString = String(Longitude, 4);
        ...
        ble.println(flagString + "," + latString + "," + lngString);
